...
Una nuova idea di web totalmente decentralizzato, basato su protocolli inediti e, soprattutto, sulla tecnologia **blockchain** L’obiettivo è cambiare radicalmente l’attuale funzionamento della rete, **eliminando la differenza tra client e server** introducendo la blockchain. La blockchain prevede che l’informazione venga **archiviata in più copie** e distribuita all’interno di una rete di computer peer-to-peer. Leggi di più da docs Blockchain
